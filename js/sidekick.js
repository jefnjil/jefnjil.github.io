...
function DBJSLoaded()
{
	...
	if ( uss != null ) 
	{
		...
		ua.innerHTML = '　<a target="_blank" href="http://album.udn.com/photo/photo_slider.jsp?uid=jefnjil&f_BOOK_ID=' + uss + '"><img valign=middle src="' + myweb + 'img/play.png" title="自動播放相簿" /></a>　';
	}
